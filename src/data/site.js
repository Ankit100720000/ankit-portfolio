...
export const skillGroups = [
  ...
  },
  {
    ...
    description: 'Animation, charting, build tools, and developer workflow.',
...
export const experience = [
  {
    ...
    points: [
      'Built CRM & ERP modules using React.js + Redux Toolkit, serving 500+ daily active users.',
      'Unified global state with Redux Toolkit across CRM & ERP, cutting data inconsistency by 40%.',
      'Tracked real-time KPIs via Highcharts dashboards, saving 5 hours of manual reporting weekly.',
      'Accelerated page load by 30% through lazy loading, code splitting, and memoization.',
      'Owned UI/UX design for CRM and ERP screens, reducing UI rework requests by 25%.',
    ],
  },
  {
    ...
    points: [
      'Spearheaded development of 25+ responsive apps for e-commerce, real estate, and SaaS clients.',
      'Engineered product listing pages with multi-filter search, lifting user engagement by 35%.',
      'Converted 50+ Figma designs into pixel-perfect, mobile-first interfaces.',
      'Elevated Google Lighthouse scores from 65 to 92 using semantic HTML and structured data.',
      'Built AI-powered OCR pipeline using Mistral AI, Claude AI, and Gemma 4 APIs.',
    ],
  },
  {
    ...
    points: [
      'Created 20+ responsive landing pages and corporate websites for diverse clients.',
      'Established a reusable UI library of buttons, modals, and carousels across 10+ projects.',
      'Enforced WCAG 2.1 accessibility standards, reducing accessibility complaints by 90%.',
      'Standardized CSS utilities and JS snippets, trimming team development time by 15%.',
    ],
  },
]
...
export const contact = {
  ...
  portfolio: 'https://ankit-portfolio-bay.vercel.app',
