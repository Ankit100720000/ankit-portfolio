...
const socialLinks = [
  {
    label: "GitHub",
    icon: <GithubIcon />,
    href: "https://github.com/ankitmaurya-dev",
  },
  {
    label: "LinkedIn",
    icon: <LinkedinIcon />,
...
function HeroSection() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      // Smooth GSAP fade-out and slide-up
      gsap.to(".role-text-word", {
        opacity: 0,
        y: -12,
        duration: 0.35,
        ease: "power2.in",
        onComplete: () => {
          ...
          // Smooth GSAP fade-in and slide-up from bottom
          gsap.fromTo(
            ".role-text-word",
            { opacity: 0, y: 12 },
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40">
        ...
        <div
          className="h-10 w-px bg-gradient-to-b from-[var(--accent)] to-transparent"
